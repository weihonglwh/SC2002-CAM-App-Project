                            ...
                            while(staffChoice != 15) {
                                ...
                                switch(staffChoice){
                                    ...
                                    case 4: // view all camps
                                        ...
                                        System.out.print(">> ");
                                        if (sc.hasNextInt()){
                                            staffFilterChoice = sc.nextInt();
                                        }
                                        sc.nextLine();
                                        while(staffFilterChoice!=1 && staffFilterChoice !=2 && staffFilterChoice!=3){
                                            System.out.println("Error! Please select again");
                                            System.out.println("> What would you like to filter by? <");
                                            System.out.println("1) Date");
                                            System.out.println("2) Location");
                                        ...
                                        switch(staffFilterChoice){
                                            case 1:
                                                System.out.println("> What date would you like to filter by <");
                                                System.out.println("> Please enter the start date (dd/MM/yyyy) <");
                                                System.out.print(">> ");
                                                String filterDateString = sc.next();
                                                Date filterDate = DateUtility.stringToDate(filterDateString);
                                                while(filterDate == null){
                                                    filterDateString = sc.next();
                                                    filterDate = DateUtility.stringToDate(filterDateString);
                                                }
                                                campStorage.printData(new SearchDateFilter(), filterDate);
                                                break;
                                            case 2:
                                                System.out.println("> What location would you like to filter by <");
                                                System.out.print(">> ");
                                                String userLocation = sc.nextLine();
                                                campStorage.printData(new SearchLocationFilter(), userLocation);
                                                break;
                                            case 3:
                                                campStorage.printData(null,null);
                                                break;
                                        }
                                        break;
                            ...
                            while(studentChoice != 13)
                            {
                                ...
                                switch(studentChoice){
                                    ...
                                    case 2: // view list of camp available
                                        ...
                                        System.out.print(">> ");
                                        if (sc.hasNextInt()){
                                            filterViewChoice = sc.nextInt();
                                        }
                                        sc.nextLine();
                                        while(filterViewChoice!=1 && filterViewChoice!=2 && filterViewChoice!=3) {
                                            System.out.println("[ Error, please select again ]");
                                            System.out.println("> What would you like to filter by <");
                                            System.out.println("1) Date");
                                            System.out.println("2) Location");
                                        ...
                                        switch(filterViewChoice){
                                            case 1:
                                                ...
                                                campStorage.printData(studentAccount, new SearchDateFilter(), filterDate);
                                                break;
                                            case 2:
                                                System.out.println("> What location would you like to filter by <");
                                                String userLocation = sc.nextLine();
                                                campStorage.printData(studentAccount, new SearchLocationFilter(), userLocation);
                                                break;
                                            case 3:
                                                campStorage.printData(studentAccount, null, null);
                                                break;
                                        }
                                        break;
                                        ...
                                        if( userRegCampObj == null || !userRegCampObj.getVisibility()){
                                            ...
                                            if ((userRegCampObj.getUserGroup().equals(studentAccount.getFaculty()) || userRegCampObj.getUserGroup().equals("NTU"))){
                                                ...
                                                if (new Date().before(userRegCampObj.getRegDeadline())){
                                                    ...
                                                    System.out.println("[ It is past the registration deadline! ]"); //Error handling
                                                }
                                            }
                                            else{
                                            ...
                                            while(studentCampCommChoice != 10) {
                                                ...
                                                switch (studentCampCommChoice) {
                                                    ...
                                                    case 3:
                                                        ...
                                                        suggestionStorage.printData(studentAccount);
                                                        break;
                                                    // 4) Edit suggestion
                                                    case 4:
