...
public class UiPrinter {
    ...
    public static void printCampInformation(Camp camp){
        int nameLength = camp.getName().length();
        int totalEquals = 66 - (21 + nameLength);

        if(totalEquals%2 == 1)
            System.out.print("=".repeat((totalEquals/2)+1));
        else
            System.out.print("=".repeat(totalEquals/2));
        System.out.println(" Camp Information - " + camp.getName() + " " + "=".repeat(totalEquals/2));
    ...
    public static void printCampInfoForStudents(Camp campStudent){
        int nameLength = campStudent.getName().length();
        int totalEquals = 66 - (21 + nameLength);
        ...
        if(totalEquals%2 == 1)
            ...
            System.out.print("=".repeat(totalEquals/2));
        System.out.println(" Camp Information - " + campStudent.getName() + " " + "=".repeat(totalEquals/2));
    ...
    public static void printStudentProfile(StudentAccount student){
        ...
        for (String tarCamp: student.getCampsRegistered())
            System.out.printf("| %-20s | %-20s |%n", tarCamp, "Attendee");
        System.out.println("-----------------------------------------------");
    }
}
